                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="position-relative">
                            <div class="initials-letter rounded-3">
                                <img src="{{ auth()->user()->image_path }}" width="150" height="150" style="border-radius: 15%">
                            </div>
                        </div>
                    </div>
                    <div class="col my-auto">
                        <div class="h-150">
                            <h5 class="mb-1" style="font-size: 30px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" value=" {{ auth()->user()->role->name }} "
                                            type="text" id="user-role" name="role" placeholder="Role" disabled>
                                        @error('role')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                    </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body pt-4 p-3">
                    ...
                    <form action="/change-password" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="('old-password')border border-danger rounded-3 ">
                                        <input class="form-control" value="" type="password" required
                                            placeholder="Enter old password" id="old-password" name="old_password">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="('new-password')border border-danger rounded-3 ">
                                        <input class="form-control" value="" type="password" required
                                            minlength="8" placeholder="Enter new password" id="new-password"
                                            name="new_password">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="('confirm-password')border border-danger rounded-3 ">
                                        <input class="form-control" value="" type="password" required
                                            placeholder="confirm password" id="confirm-password" name="c_password">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit"
                                class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Change password' }}</button>
                        </div>
                    </form>
