            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-bolder text-info text-gradient">Welcome to Travlink</h3>
                  <p>Travlink connects travellers and journeys from all over the world. We're here to make your next adventure as easy and enjoyable as possible.</p>
                  <p class="mb-0"> <strong> Sign In </strong><br></p>
                </div>
                <div class="card-body">
