    ...
    <div>
        <div class="nav-wrapper position-relative end-0">
            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#actived-tabs-simple" role="tab"
                        aria-controls="dashbaord" aria-selected="false">
                        Active customers
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#suspended-tabs-simple" role="tab"
                        aria-controls="dashbaord" aria-selected="false">
                        Suspended customers
                    </a>
                </li>
        ...
        <div class="tab-content">
            ...
            <!-- Active -->
            <div class="tab-pane fade" id="actived-tabs-simple" role="tabpanel"
                aria-labelledby="actived-tabs-simple-tab">
                <div class="container-fluid py-4">
                    <div class="card">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
            ...
            <!-- Suspended -->
            <div class="tab-pane fade" id="suspended-tabs-simple" role="tabpanel"
                aria-labelledby="suspended-tabs-simple-tab">
                <div class="container-fluid py-4">
                    <div class="card">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
