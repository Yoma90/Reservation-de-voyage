  ...
  <div class="collapse navbar-collapse h-100 w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('customer-management') ? 'active' : '') }}" href="{{ url('customer-management') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('customer-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('manager-management') ? 'active' : '') }}" href="{{ url('manager-management') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('manager-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Manager Management</span>
        </a>
      </li>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('history') ? 'active' : '') }}" href="{{ url('history') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('history') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('destination-management') ? 'active' : '') }}" href="{{ url('destination-management') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('destination-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
